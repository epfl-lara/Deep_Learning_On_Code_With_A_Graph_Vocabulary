...
if __name__ == '__main__':
    kwargs = dict(seed=515,
                  ...
                  model_names_labels_and_prepro_kwargs=[
                      ('VarNamingFixedVocabGGNN', 'all_edge', frozenset(),
                       dict(),
                       dict(max_nodes_per_graph=500)),
                      ('VarNamingCharCNNGGNN', 'all_edge', frozenset(),
                       dict(max_name_encoding_length=30),
                       dict(max_nodes_per_graph=500)),
                      ('VarNamingNameGraphVocabGGNN', 'all_edge', frozenset(),
                       dict(max_name_encoding_length=30),
                       dict(max_nodes_per_graph=500)),
                      ('VarNamingFixedVocabGGNN', 'syntax_edge', syntax_only_excluded_edge_types,
                       dict(),
                       dict(max_nodes_per_graph=500)),
                      ('VarNamingCharCNNGGNN', 'syntax_edge', syntax_only_excluded_edge_types,
                       dict(max_name_encoding_length=30),
                       dict(max_nodes_per_graph=500)),
                      ('VarNamingNameGraphVocabGGNN', 'syntax_edge', syntax_only_excluded_edge_types,
                       dict(max_name_encoding_length=30),
                       dict(max_nodes_per_graph=500)),
                  ],
