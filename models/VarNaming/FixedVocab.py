...
from data.Batch import Batch, FixedVocabInput
...
class VarNamingFixedVocabDataPoint:
...
class VarNamingFixedVocabDataEncoder(BaseDataEncoder):
    DataPoint = VarNamingFixedVocabDataPoint
    ...
    def encode(self, dp: VarNamingFixedVocabDataPoint) -> None:
        '''
...
class VarNamingFixedVocab(VarNamingModel):
    '''
    Model that relies on a fixed vocabulary to do the VarNaming task
    '''

    DataEncoder = VarNamingFixedVocabDataEncoder
    InputClass = FixedVocabInput
