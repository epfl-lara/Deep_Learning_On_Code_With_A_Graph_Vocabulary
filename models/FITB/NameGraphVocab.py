...
from data.Batch import NameGraphVocabInput
...
class FITBNameGraphVocabDataPoint(FITBCharCNNDataPoint):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)


class FITBNameGraphVocabDataEncoder(FITBCharCNNDataEncoder):
    DataPoint = FITBNameGraphVocabDataPoint
...
class FITBNameGraphVocab(FITBCharCNN):
    '''
    Model that embeds variable names into a Graph Vocabulary to do the FITB task
    '''

    DataEncoder = FITBNameGraphVocabDataEncoder
    ...
    def instance_to_datapoint(graph: AugmentedAST,
                              instance,
                              data_encoder: FITBNameGraphVocabDataEncoder,
