...
from models import FITBFixedVocabGGNN, FITBCharCNNGGNN, VarNamingNameGraphVocabGGNN
...
class TestEvaluateModel(unittest.TestCase):
    ...
    def test_evaluate_model_with_FITBFixedVocabGGNN(self):
        ...
        data_encoder = os.path.join(self.train_output_dataset_dir, 'FITBFixedVocabDataEncoder.pkl')
    ...
    def test_evaluate_gives_the_same_results_as_in_training_loop_with_FITBFixedVocabGGNN(self):
        preprocess_task_for_model(seed=234,
                                  task_class_name='FITBTask',
                                  task_filepath=self.train_task_filepath,
                                  model_name='FITBFixedVocabGGNN',
        ...
        for f in [os.path.join(self.train_output_dataset_dir, f) for f in os.listdir(self.train_output_dataset_dir)]:
            if f not in val_data and f != os.path.join(self.train_output_dataset_dir, 'FITBFixedVocabDataEncoder.pkl'):
                os.remove(f)
        model_checkpoint_path = os.path.join(self.train_log_dir, 'model.pkl')
...
class TestEvaluateModelVarNaming(unittest.TestCase):
    ...
    def test_evaluate_model_with_VarNamingNameGraphVocabGGNN(self):
        preprocess_task_for_model(seed=234,
                                  ...
                                  data_encoder_kwargs=dict(max_name_encoding_length=10),
                                  instance_to_datapoints_kwargs=dict(max_nodes_per_graph=100))
        data_encoder = os.path.join(self.train_output_dataset_dir, 'VarNamingNameGraphVocabDataEncoder.pkl')
        preprocess_task_for_model(seed=235,
                                  task_class_name='VarNamingTask',
                                  task_filepath=self.test_task_filepath,
                                  model_name='VarNamingNameGraphVocabGGNN',
