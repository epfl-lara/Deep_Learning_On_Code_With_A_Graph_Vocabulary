...
class TestEvaluateModelsForExperiment(unittest.TestCase):
    ...
    def test_basic_functionality_with_FITBFixedVocabGGNN(self):
        make_tasks_and_preprocess(seed=514,
                                  ...
                                  model_names_labels_and_prepro_kwargs=[
                                      ('FITBFixedVocabGGNN', 'all_edge', frozenset(), dict(),
    ...
    def test_basic_functionality_with_FITBNameGraphVocabGGNN(self):
        make_tasks_and_preprocess(seed=514,
                                  dataset_name=self.dataset_name,
                                  experiment_name=self.experiment_name,
                                  n_jobs=30,
